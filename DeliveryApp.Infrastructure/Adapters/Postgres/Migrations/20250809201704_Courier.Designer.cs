...
namespace DeliveryApp.Infrastructure.Adapters.Postgres.Migrations
{
    ...
    [Migration("20250809201704_Courier")]
            ...
            modelBuilder.Entity("DeliveryApp.Core.Domain.Model.CourierAggregate.Courier", b =>
                {
                    ...
                    b.OwnsOne("DeliveryApp.Core.Domain.Model.SharedKernel.Speed", "Speed", b1 =>
                        {
                            b1.Property<Guid>("CourierId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DeliveryApp.Core.Domain.Model.CourierAggregate.StoragePlace", b =>
                {
                    ...
                    b.OwnsOne("DeliveryApp.Core.Domain.Model.SharedKernel.Volume", "TotalVolume", b1 =>
                        {
                            b1.Property<Guid>("StoragePlaceId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("StoragePlaceId");

                            b1.ToTable("storage_places");
